...
jobs:
  dispatch:
    ...
    env:
      ...
      CLAWSWEEPER_APP_CLIENT_ID: ${{ vars.CLAWSWEEPER_APP_CLIENT_ID || 'Iv23li7FTsSTorJDMkdQ' }}
    ...
    steps:
      ...
      - name: Dispatch exact ClawSweeper review
        ...
        run: |
          ...
          gh api repos/AyobamiH/clawsweeper/dispatches \
            --method POST \
            --input - <<< "$payload"
      ...
      - name: Acknowledge and dispatch ClawSweeper comment
        ...
        run: |
          ...
          GH_TOKEN="$DISPATCH_TOKEN" gh api repos/AyobamiH/clawsweeper/dispatches \
            --method POST \
            --input - <<< "$payload"
```
